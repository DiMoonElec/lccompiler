...
{
  internal class IntConstantValue : IntegerConstantValue
  {
    public int Value { get; private set; }

    public IntConstantValue(int value) : base(new LCPrimitiveType(LCPrimitiveType.PrimitiveTypes.LCTypeInt))
    {
      Value = value;
    }
    ...
    {
      if (rightValue is IntConstantValue rightIntegerConstant)
        return new IntConstantValue((int)(Value + rightIntegerConstant.Value));
    ...
    public override ConstantValue RightShift(ConstantValue rightValue)
    {
      if (rightValue is ByteConstantValue rightIntegerConstant)
        return new IntConstantValue((int)(Value >> (int)rightIntegerConstant.Value));
    ...
    {
      return new IntConstantValue((int)(Value + 1));
    }
