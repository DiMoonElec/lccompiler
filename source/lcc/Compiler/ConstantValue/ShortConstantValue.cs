...
{
  internal class ShortConstantValue : IntegerConstantValue
  {
    public short Value { get; private set; }

    public ShortConstantValue(short value) : base(new LCPrimitiveType(LCPrimitiveType.PrimitiveTypes.LCTypeShort))
    {
      Value = value;
    }
    ...
    {
      if (rightValue is ShortConstantValue rightIntegerConstant)
        return new ShortConstantValue((short)(Value + rightIntegerConstant.Value));
    ...
    public override ConstantValue RightShift(ConstantValue rightValue)
    {
      if (rightValue is ByteConstantValue rightIntegerConstant)
        return new ShortConstantValue((short)(Value >> (int)rightIntegerConstant.Value));
    ...
    {
      return new ShortConstantValue((short)(Value + 1));
    }
