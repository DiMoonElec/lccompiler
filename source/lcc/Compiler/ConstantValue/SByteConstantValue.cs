...
{
  internal class SByteConstantValue : IntegerConstantValue
  {
    public sbyte Value { get; private set; }

    public SByteConstantValue(sbyte value) : base(new LCPrimitiveType(LCPrimitiveType.PrimitiveTypes.LCTypeSByte))
    {
      Value = value;
    }
    ...
    {
      if (rightValue is SByteConstantValue rightIntegerConstant)
        return new SByteConstantValue((sbyte)(Value + rightIntegerConstant.Value));
    ...
    {
      if (rightValue is SByteConstantValue rightIntegerConstant)
        return new SByteConstantValue((sbyte)(Value >> (int)rightIntegerConstant.Value));
    ...
    {
      return new SByteConstantValue((sbyte)(Value + 1));
    }
      ...
      if (toType is LCPrimitiveType primitiveType)
      {
        switch (primitiveType.Type)
        {
          case LCPrimitiveType.PrimitiveTypes.LCTypeSByte:
            return new SByteConstantValue(Value);
